...
# Documentação dos circuitos desenvolvidos
 Inicialmente, um fio terra foi soldado em todos os botões. Logo após, outro fio foi soldado em um pino de um dos botões da extremidade, puxando o GND do Arduino Nano. Realizamos a ligação da porta de cada botão, os quais também foram soldados e conectados ao Arduino. Como utilizamos dois botões em uma mini protoboard, também fizemos a ligação das respectivos portas deles ao Arduino e conectamos um fio do GND até a mini protoboard.
